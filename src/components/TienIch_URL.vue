  ...
  <div class="flex-1 mt-10 md:mt-0 xl:px-5 overflow-y-auto">
    ...
    <div
      ...
      <div class="flex justify-between items-center mb-2">
        <span class="font-bold text-lg">URL Output ✍️</span>
        <a href="#"
...
export default {
  ...
  data() {
    return {
      ...
      urlData: { // Tập dữ liệu các chuỗi đầu vào, đầu ra
        inputString: "",
        outputString: ""
      },
  ...
  methods: {
    ...
    executeAction(type) {
      type === "encode"
        ? this.urlData.outputString = encodeURIComponent(this.urlData.inputString)
        : this.urlData.outputString = decodeURIComponent(this.urlData.inputString)

    },
    // Thực thi copy outputString vào clipboard
    outputCopied() {
      if (this.urlData.outputString.length > 0) {
        navigator.clipboard.writeText(this.urlData.outputString);
        this.isCopied = true;
      }
    }
  },
