    ...
    <div
      ...
      <div class="xl:col-span-7 col-span-12 p-8 space-y-2 text-black dark:text-white">
        ...
        <div class="grid grid-flow-col auto-cols-max gap-8 pt-2">
          <a :href="infoData.facebook_url === '' ? '#' : infoData.facebook_url"
          ...
          <a :href="infoData.x_url === '' ? '#' : infoData.x_url"
          ...
          <a :href="infoData.linkedin_url === '' ? '#' : infoData.linkedin_url"
          ...
          <a :href="infoData.ytb_url === '' ? '#' : infoData.ytb_url"
